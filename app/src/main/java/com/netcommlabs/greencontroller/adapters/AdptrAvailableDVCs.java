...
import com.netcommlabs.greencontroller.activities.EditSessionPlan;
        ...
        public MyViewHolder(View itemView) {
            ...
            llAvailDvcRow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intentAddWtrngProfile.putExtra(EditSessionPlan.EXTRA_NAME, dvcName);
                    intentAddWtrngProfile.putExtra(EditSessionPlan.EXTRA_ID, dvcAddress);
                    mContext.startActivity(intentAddWtrngProfile);
                    //mContext.finish();
